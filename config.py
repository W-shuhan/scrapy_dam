...
MYSQL_TABLE_LIST=['Location','City','Reservoir','WaterSupply','FlowObservatory','Forecast','IrrigationArea','ReservoirState','RegionalWaterRegime','Q90','Q95','NextReservoirLights','NextWeekP','RuleCurve','SimReservoirFlow','WaterIntakeStructures','ForecastingTime','Light','PreWaterLevel','PreWaterStorageCapacity','PeoplesLivelihoodWater','IrrigationWaterDemand']
